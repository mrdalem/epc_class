                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Spesifikasi dan Material...",style: TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 16,
                                  ),),
                                  Text("Video 14:47 Menit",style: TextStyle(
                                      fontSize: 12,
                                      height: 1.3
                                  ),),
                                  Text("Poin 20",style: TextStyle(
                                      fontSize: 12,
                                      height: 1.3
                                  ),),
                                  SizedBox(height: 10,),
                                  Row(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text("Post-test",style: TextStyle(
                                          fontWeight: FontWeight.w400,
                                          fontSize: 10,
                                          color: Color(0xffC4C4C4),
                                        ),),
                        ...
                        Column(
                          children: [
                            Text("Waktu tersisa",style: TextStyle(
                              fontSize: 10,
                            ),),
                            Text("04 : 32",style: TextStyle(
                              fontWeight: FontWeight.w500,
                              fontSize: 20,
                              height: 1.5,
                            ...
                            Row(
                              children: [
                                Padding(
                                  ...
                                  child: Text("Menit",style: TextStyle(
                                    fontSize: 5,
                                  ),),
                                ),
                                Padding(
                                  padding: EdgeInsets.fromLTRB(10, 0, 10, 0),
                                  child: Text("Detik",style: TextStyle(
                                    fontSize: 5,
                                  ),),
                                ),
