            ...
            children: <Widget>[
              Scaffold(
                ...
                body: SingleChildScrollView(
                    padding: EdgeInsets.fromLTRB(10, (MediaQuery.of(context).orientation == Orientation.portrait)? MediaQuery.of(context).size.height / 4 : MediaQuery.of(context).size.height / 2.2, 10, 0),
                    child:
                    Column(
                      children: <Widget>[
                        Container(
                ...
                children: [
                  Flexible(
                    ...
                    Container( // menu atas
                      ...
                      // height: (MediaQuery.of(context).orientation == Orientation.portrait)? MediaQuery.of(context).size.height / 4.8 : MediaQuery.of(context).size.height / 2.8,
